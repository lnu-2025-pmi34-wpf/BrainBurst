...
namespace BrainBurst.DAL.Migrations
{
    ...
    [Migration("20251125133148_AddFlashcardTagsRelation1")]
    partial class AddFlashcardTagsRelation1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlashcardTag", b =>
                {
                    b.HasOne("BrainBurst.DAL.Entities.Flashcard", null)
                        .WithMany()
                        .HasForeignKey("FlashcardsFlashcardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BrainBurst.DAL.Entities.Tag", null)
                        .WithMany()
