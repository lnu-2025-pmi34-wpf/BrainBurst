...
public class RankingService : IRatingService
{
    ...
    {
        this._logger = logger;
        this._logger.LogDebug("RankingService: Сервіс рейтингів ініціалізовано.");
    }
    ...
    public UserRank GetRank(int points)
    {
        this._logger.LogDebug("GetRank: Визначення рангу для {Points} балів.", points);
    ...
    public string GetRankLabel(UserRank rank)
    {
        this._logger.LogDebug("GetRankLabel: Отримання мітки для рангу: {Rank}", rank);
